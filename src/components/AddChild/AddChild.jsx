      ...
      <Form className="formLogin">
        ...
        <Form.Group controlId="formGroupBOD" >
          <Form.Label>Date of Birth:</Form.Label>
            <Form.Control type="date" placeholder="Date of Birth" className="placeHolder"/>
        </Form.Group>     
        <hr></hr>  
        <div className="title">
        ...
        <Row className="rowForm">
          <Form.Group controlId="formGroupWeight" >
            ...
            <Form.Control type="number" placeholder="Weight (gr)" className="placeHolder"/>
          </Form.Group>

          <Form.Group controlId="formGroupHeight" >
            <Form.Label>Height</Form.Label>
            <Form.Control type="number" placeholder="Height (cm)" className="placeHolder"/>
          </Form.Group>
        ...
        <Row className="rowForm">
          <Form.Group controlId="formGroupChest" >
            ...
            <Form.Control type="number" placeholder="Chest (cm)" className="placeHolder"/>
          </Form.Group>

          <Form.Group controlId="formGroupHead" >
            <Form.Label>Head</Form.Label>
            <Form.Control type="number" placeholder="Head (cm)" className="placeHolder"/>
          </Form.Group>          
        </Row>
      
        <Form.Group controlId="formGroupDate" >
          <Form.Label>Date of measures:</Form.Label>
            <Form.Control type="date" placeholder="Today" className="placeHolder"/>
        </Form.Group>  
